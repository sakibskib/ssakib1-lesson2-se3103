...
import controller.TriangleEvenListener;
...
public class TriangleDrawingPanel {
    ...
    public void init(){
       ...
       /*  TriangleMouseEvent mouseEvent = new TriangleMouseEvent(this);
        canvas.addMouseListener(mouseEvent);
        canvas.addMouseMotionListener(mouseEvent);*/

        //attavhing the even listernenr
        TriangleEvenListener listener = new TriangleEvenListener(this);
